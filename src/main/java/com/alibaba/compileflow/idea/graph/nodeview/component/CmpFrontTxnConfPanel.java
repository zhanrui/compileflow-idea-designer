 ...
 * @author zhan
 */
public class CmpFrontTxnConfPanel extends JPanel {
    ...
    private JButton addRowBtn = new JButton("增加菜单项");
    private JButton copyRowBtn = new JButton("复制菜单项");
    private JButton deleteRowBtn = new JButton("删除菜单项");

    //    private String[] columnNames = new String[] {"sceneCode1", "txnCode1", "fieldCode1, sceneCode2", "txnCode2", "fieldCode2"};
    private String[] columnNames = new String[]{"顺序号", "交易名称", "交易码", "备注"};
    private DefaultTableModel tableModel = new DefaultTableModel(columnNames, 0);
    private JTable table = new JBTable(tableModel);

    private Project project;

    public CmpFrontTxnConfPanel(Project project) {
