 ...
 * @author zhan
 */
public class CmpTaskPanel extends JPanel {
    ...
    private CmpFrontTxnConfPanel mappingPanel;

    public CmpTaskPanel(Project project) {
        super(new MigLayout("inset 20"));
        mappingPanel = new CmpFrontTxnConfPanel(project);
        initView();
        initListener();
    }
...
*/
    ...
    public CmpTaskPanel.Data getData() {
        CmpTaskPanel.Data data = new CmpTaskPanel.Data();
    ...
    public void setData(CmpTaskPanel.Data data) {
    ...
    public CmpFrontTxnConfPanel getMappingPanel() {
        return mappingPanel;
    }
}
