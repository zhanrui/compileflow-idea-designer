 ...
 * @author zhan
 */
public abstract class TxnBaseDialog extends DialogWrapper {
...
//    protected TxnNodeBasicPanel basicPanel = new TxnNodeBasicPanel();
    protected NodeBasicPanel basicPanel = new NodeBasicPanel();
    protected JPanel paramPanel;

    public TxnBaseDialog(@Nullable Project project, mxCell cell, Graph graph) {
        super(project);
        this.cell = cell;
        this.graph = graph;
    ...
    private void initData() {
        ...
        //TODO zhan
//        TxnTaskNodeModel txnModel = TxnTaskNodeModel.getFromCellValue(cell.getValue());
//        basicData.txnCode = txnModel.getTxnCode();
