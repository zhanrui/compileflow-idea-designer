 ...
 * @author zhan
 */
public class GlobalTxnFieldsMappingPanel extends JPanel {
    ...
    private String[] columnNames = new String[]{"原场景码", "原交易码", "原字段码", "当前交易码", "当前字段码"};
    private DefaultTableModel tableModel = new DefaultTableModel(columnNames, 0);
    private JTable table = new JBTable(tableModel);

    private Project project;

    public GlobalTxnFieldsMappingPanel(Project project) {
